...
#ifndef ICSDKEKYCHDSAISON_SWIFT_H
#define ICSDKEKYCHDSAISON_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ICSdkEKYCHDSaison",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison15AnimatedControl")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison14AnimatedButton")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison14AnimatedSwitch")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison16AnimationSubview")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison19CompatibleAnimation")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison26CompatibleAnimationKeypath")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison23CompatibleAnimationView")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison32CompatibleDictionaryTextProvider")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison13DPVideoMatrix")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison13DPVideoMerger")
...
@interface DPVideoMerger (SWIFT_EXTENSION(ICSdkEKYCHDSaison))
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison14ICEkycConstant")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull FontSemiBold;)
+ (NSString * _Nonnull)FontSemiBold SWIFT_WARN_UNUSED_RESULT;
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison20LottieAnimationLayer")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison23LottieAnimationViewBase")
...
/// </ul>
IB_DESIGNABLE
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison19LottieAnimationView")
...
SWIFT_CLASS("_TtC17ICSdkEKYCHDSaison13QRScannerView")
...
@interface QRScannerView (SWIFT_EXTENSION(ICSdkEKYCHDSaison)) <AVCaptureMetadataOutputObjectsDelegate>
...
@interface QRScannerView (SWIFT_EXTENSION(ICSdkEKYCHDSaison)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end


@interface QRScannerView (SWIFT_EXTENSION(ICSdkEKYCHDSaison))
...
SWIFT_PROTOCOL("_TtP17ICSdkEKYCHDSaison21QRScannerViewDelegate_")
@protocol QRScannerViewDelegate
...
@interface UIImage (SWIFT_EXTENSION(ICSdkEKYCHDSaison))
...
@interface UITapGestureRecognizer (SWIFT_EXTENSION(ICSdkEKYCHDSaison))
